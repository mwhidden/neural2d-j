 ...
 */
public class TrainingConfig extends XMLConfig
{
    ...
    public TrainingConfig() throws ConfigurationException
    {
        errorThreshold = 0.01;
        eta = 0.01;                    // Initial overall net learning rate, [0.0..1.0]
        dynamicEta = false;       // true enables automatic eta adjustment during training
    ...
    public TrainingConfig(Node parent) throws ConfigurationException
    {
        this();
